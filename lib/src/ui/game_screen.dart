    ...
    return SizedBox(
      ...
      child: FilledButton(
        ...
        style: FilledButton.styleFrom(
          backgroundColor: const Color(0xFF2A5E54),
          foregroundColor: const Color(0xFFF0E5D0),
          disabledBackgroundColor: const Color(0xFF1A3D36),
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(
          ...
          side: const BorderSide(color: Color(0x44F0E5D0)),
          shape: RoundedRectangleBorder(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _infoParagraph(
                'Letters fall one at a time onto a 7\u00d714 board. '
              ...
              _infoParagraph(
                ...
                'also clears and scores at half the normal rate. '
                'Use this strategically when words aren\'t possible.',
              ),
              const SizedBox(height: 12),
              _infoHeading('Blank Tiles  \u2605'),
              _infoParagraph(
                'Occasionally a blank tile (\u2605) appears. It\'s worth 0 points '
                'but when it lands, it becomes whichever letter forms the '
                'best-scoring word at that position.',
              ),
              const SizedBox(height: 12),
